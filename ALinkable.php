...
class ALinkable extends CBehavior implements IALinkable
{
	...
	public function createUrl($action = null, $params = null, $absolute = false) {
		...
		if ($absolute) {
			...
			if (isset(Yii::app()->controller)) {
				return Yii::app()->controller->createAbsoluteUrl($route, $params,$schema);
			}
	...
	public function createLink($anchorText = null, $params = null, $htmlOptions = array(), $absolute = false) {
		...
		$htmlOptions = CMap::mergeArray($this->defaultHtmlOptions,$htmlOptions);
		return CHtml::link($anchorText,$this->owner->createUrl($action,$params,$absolute),$htmlOptions);
